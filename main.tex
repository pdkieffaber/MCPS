...
\usepackage{fancyvrb} %fancy Verbatim sutff
...
\sisetup{
  ...
  table-format=4.3, detect-all % optional: controls decimal formatting
}
%\newcolumntype{C}{S}
...
%\include{PsyToolkit/PsyToolkit}

%\include{Introduction2Spreadsheets/Introduction2Spreadsheets}

%\part{Methods in Context}

%\include{Sensation And Perception/SensationAndPerception}
%\include{FeatureProcessing/FeatureProcessing}

%\include{ThePerceptron/thePerceptron}


\part{PSYC672}

\include{ReproducibleResearch/Intro2Git}
%\include{Introduction2Latex/Intro2Latex}

%\include{Introduction2R/Introduction2R}

%\include{LinearMixedModels/LinearMixedModels}



%\include{GraphTheory/GraphTheory}
